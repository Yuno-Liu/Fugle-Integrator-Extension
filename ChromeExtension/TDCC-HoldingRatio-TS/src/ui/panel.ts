...
import type { PanelElements } from "../types/index.js";
 ...
 */
function requireElement<T extends Element>(panel: HTMLElement, selector: string): T {
 ...
 */
export function createPanel(doc: Document = document): HTMLDivElement {
 ...
 * @param doc - DOM Document 物件 (預設為全域 document)
 */
export function removeExistingPanel(doc: Document = document): void {
 ...
 */
export function getPanelElements(panel: HTMLDivElement): PanelElements {
    return {
        panel,
        header: requireElement<HTMLElement>(panel, "#stk-header"),
        retailSelect: requireElement<HTMLSelectElement>(panel, "#retail-lvl"),
        whaleSelect: requireElement<HTMLSelectElement>(panel, "#whale-lvl"),
        retailResult: requireElement<HTMLElement>(panel, "#res-retail"),
        whaleResult: requireElement<HTMLElement>(panel, "#res-whale"),
        retailProgress: requireElement<HTMLElement>(panel, "#progress-retail"),
        whaleProgress: requireElement<HTMLElement>(panel, "#progress-whale"),
        status: requireElement<HTMLElement>(panel, "#stk-status"),
        dataStatus: requireElement<HTMLElement>(panel, "#stk-data-status"),
        refreshButton: requireElement<HTMLButtonElement>(panel, "#stk-refresh"),
    };
}
