 ...
 * - p: 實際的輸入文字區塊
 */
export const INPUT_XPATH = `/html/body/chat-app/main/side-navigation-v2/bard-sidenav-container/bard-sidenav-content/div[2]/div/div/bots-chat-window/chat-window/div/input-container/fieldset/input-area-v2/div/div/div[1]/div/div/div/rich-textarea/div[1]/p`;
 ...
 * - 填入文字後，按鈕變為 enabled
 */
export const SEND_BUTTON_XPATH = `/html/body/chat-app/main/side-navigation-v2/bard-sidenav-container/bard-sidenav-content/div[2]/div/div/bots-chat-window/chat-window/div/input-container/fieldset/input-area-v2/div/div/div[3]/div[2]/div[2]/button`;
